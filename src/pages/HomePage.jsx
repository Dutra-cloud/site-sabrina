...
const HomePage = () => {
    ...
    return (
        <div className="space-y-12">
            {/* Hero Section */}
            <section className="relative h-[500px] md:h-[600px] rounded-3xl overflow-hidden flex items-center px-6 md:px-20 shadow-2xl">
                ...
                <div className="max-w-3xl z-10 relative animate-fade-in-up">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight whitespace-pre-line text-white drop-shadow-lg">
                        {banner.title}
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-100 mb-10 max-w-xl leading-relaxed drop-shadow-md">
                        {banner.subtitle}
                    </p>
